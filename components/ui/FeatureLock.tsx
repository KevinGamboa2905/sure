...
export function FeatureLock({
  ...
  const hasAccess =
    isInTrial ||
    (requiredPlan === "pro" && (currentPlan === "pro" || currentPlan === "premium")) ||
  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        aria-label={`${featureName} — plan ${requiredPlan} requis`}
      >
      ...
      {showTooltip && (
        ...
        >
          <p className="mb-2 text-sm font-medium">
            Passez en plan {requiredPlan === "pro" ? "Pro" : "Premium"} pour accéder à {featureName}.
          </p>
